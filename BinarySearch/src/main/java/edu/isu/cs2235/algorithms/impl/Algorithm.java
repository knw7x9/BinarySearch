 ...
 */
public abstract class Algorithm implements edu.isu.cs2235.algorithms.ArraySearch {
    /**
     * Generates an algorithm class
     */
    public Algorithm() {
    }
     ...
     */
    @Override
    public abstract <E extends Comparable> int search(E[] array, E item);
}
